...
if (!isset($_SESSION["is_auth"]) || !$_SESSION["is_auth"]) {
    ...
    '<div class="container mt-4">
            <h1>Авторизация</h1>
            <form class="displayed" action="/vendor/authorize.php" method="post">
                ...
                <button class="btn btn-success mt-4 displayed" type="submit">Войти</button>
                <div id="noscript_error"></div>
                <p class="mt-4">
                    У Вас ещё нет аккаунта? - <a href="sign-up.php">Зарегистрируйтесь!</a>
                </p>
            </form>
        </div>
        ';
